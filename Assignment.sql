-- Creating the Assignment Schema and allowing updates
create schema `Assignment`;
use Assignment;
SET SQL_SAFE_UPDATES = 0;
-- Checking created tables after importing from csv
-- Important : Import table name bajaj_auto, eicher_motors, hero_motocorp, infosys, tcs, tvs_motors
show tables;
...
SELECT generate_signal('2018-07-30') AS Signal_generated;  -- hold
SELECT generate_signal('2017-06-13') AS Signal_generated;  -- sell
SELECT generate_signal('2015-05-18') AS Signal_generated;  -- buy
